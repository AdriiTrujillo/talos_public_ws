...
"""autogenerated by genpy from dynamic_introspection/MarkerParameter.msg. Do not edit."""
import codecs
import sys
...
class MarkerParameter(genpy.Message):
  _md5sum = "320e3e3c740e97c435a8a239a215ff23"
  _type = "dynamic_introspection/MarkerParameter"
...
"""
  ...
  _slot_types = ['string','visualization_msgs/MarkerArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MarkerParameter, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.name is None:
        self.name = ''
      if self.value is None:
        self.value = visualization_msgs.msg.MarkerArray()
    else:
      self.name = ''
      self.value = visualization_msgs.msg.MarkerArray()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.value.markers)
      buff.write(_struct_I.pack(length))
      for val1 in self.value.markers:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.value.markers.append(val1)
      return self
