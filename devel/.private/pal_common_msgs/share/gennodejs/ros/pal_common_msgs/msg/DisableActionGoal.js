...
let DisableGoal = require('./DisableGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class DisableActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DisableGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DisableActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = DisableGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new DisableGoal()
    }
...
module.exports = DisableActionGoal;
