...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4Bi3I().pack(_x.action_goal.goal.plan, _x.action_goal.goal.checkSafety, _x.action_goal.goal.repeat, _x.action_goal.goal.priority, _x.action_goal.goal.queueTimeout, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.filename = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.filename = str[start:end]
      _x = self
      start = end
      end += 20
      (_x.action_goal.goal.plan, _x.action_goal.goal.checkSafety, _x.action_goal.goal.repeat, _x.action_goal.goal.priority, _x.action_goal.goal.queueTimeout, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_4Bi3I().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_4Bi3I = None
def _get_struct_4Bi3I():
    global _struct_4Bi3I
    if _struct_4Bi3I is None:
        _struct_4Bi3I = struct.Struct("<4Bi3I")
    return _struct_4Bi3I
_struct_B = None
def _get_struct_B():
    global _struct_B
