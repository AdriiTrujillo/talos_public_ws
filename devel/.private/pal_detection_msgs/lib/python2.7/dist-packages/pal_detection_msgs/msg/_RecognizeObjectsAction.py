...
"""autogenerated by genpy from pal_detection_msgs/RecognizeObjectsAction.msg. Do not edit."""
import codecs
import sys
...
class RecognizeObjectsAction(genpy.Message):
  _md5sum = "ff6e623bde3f5b96aae74e564c1c1660"
  _type = "pal_detection_msgs/RecognizeObjectsAction"
...
"""
  ...
  _slot_types = ['pal_detection_msgs/RecognizeObjectsActionGoal','pal_detection_msgs/RecognizeObjectsActionResult','pal_detection_msgs/RecognizeObjectsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecognizeObjectsAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pal_detection_msgs.msg.RecognizeObjectsActionGoal()
      if self.action_result is None:
        self.action_result = pal_detection_msgs.msg.RecognizeObjectsActionResult()
      if self.action_feedback is None:
        self.action_feedback = pal_detection_msgs.msg.RecognizeObjectsActionFeedback()
    else:
      self.action_goal = pal_detection_msgs.msg.RecognizeObjectsActionGoal()
      self.action_result = pal_detection_msgs.msg.RecognizeObjectsActionResult()
      self.action_feedback = pal_detection_msgs.msg.RecognizeObjectsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.input_image.header.seq, _x.action_goal.goal.input_image.header.stamp.secs, _x.action_goal.goal.input_image.header.stamp.nsecs))
      _x = self.action_goal.goal.input_image.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.input_image.format
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.input_image.data
      length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_result.result.image.format
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_h3I().pack(_x.action_result.result.num_detections, _x.action_result.result.recognized_objects.header.seq, _x.action_result.result.recognized_objects.header.stamp.secs, _x.action_result.result.recognized_objects.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.input_image.header.seq, _x.action_goal.goal.input_image.header.stamp.secs, _x.action_goal.goal.input_image.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.input_image.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.input_image.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.input_image.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.input_image.format = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.action_goal.goal.input_image.data = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.image.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.image.format = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.num_detections, _x.action_result.result.recognized_objects.header.seq, _x.action_result.result.recognized_objects.header.stamp.secs, _x.action_result.result.recognized_objects.header.stamp.nsecs,) = _get_struct_h3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
