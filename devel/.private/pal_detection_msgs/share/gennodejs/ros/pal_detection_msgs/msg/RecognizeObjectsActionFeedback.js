...
class RecognizeObjectsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new RecognizeObjectsFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RecognizeObjectsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RecognizeObjectsActionFeedback(null);
    ...
    data.feedback = RecognizeObjectsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecognizeObjectsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RecognizeObjectsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RecognizeObjectsFeedback()
    }
...
module.exports = RecognizeObjectsActionFeedback;
