...
"""autogenerated by genpy from pal_device_msgs/DoTimedLedEffectActionResult.msg. Do not edit."""
import codecs
import sys
...
class DoTimedLedEffectActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pal_device_msgs/DoTimedLedEffectActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_device_msgs/DoTimedLedEffectResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DoTimedLedEffectActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_device_msgs.msg.DoTimedLedEffectResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_device_msgs.msg.DoTimedLedEffectResult()
