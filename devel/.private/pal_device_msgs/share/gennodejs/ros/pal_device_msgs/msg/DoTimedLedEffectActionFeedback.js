...
class DoTimedLedEffectActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new DoTimedLedEffectFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DoTimedLedEffectFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DoTimedLedEffectActionFeedback(null);
    ...
    data.feedback = DoTimedLedEffectFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoTimedLedEffectActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = DoTimedLedEffectFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new DoTimedLedEffectFeedback()
    }
...
module.exports = DoTimedLedEffectActionFeedback;
