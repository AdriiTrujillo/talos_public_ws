...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.lang_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.grammar = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_result.result.file = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_feedback.feedback.recognised_utterance.text = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.recognised_utterance.text = str[start:end]
      _x = self
      start = end
      end += 17
      (_x.action_feedback.feedback.recognised_utterance.confidence, _x.action_feedback.feedback.recognised_utterance.start.secs, _x.action_feedback.feedback.recognised_utterance.start.nsecs, _x.action_feedback.feedback.recognised_utterance.end.secs, _x.action_feedback.feedback.recognised_utterance.end.nsecs,) = _get_struct_b4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
