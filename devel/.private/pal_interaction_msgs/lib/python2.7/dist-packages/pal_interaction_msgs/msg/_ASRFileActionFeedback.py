...
string value"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_b4I().pack(_x.feedback.recognised_utterance.confidence, _x.feedback.recognised_utterance.start.secs, _x.feedback.recognised_utterance.start.nsecs, _x.feedback.recognised_utterance.end.secs, _x.feedback.recognised_utterance.end.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.recognised_utterance.text = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.feedback.recognised_utterance.text = str[start:end]
      _x = self
      start = end
      end += 17
      (_x.feedback.recognised_utterance.confidence, _x.feedback.recognised_utterance.start.secs, _x.feedback.recognised_utterance.start.nsecs, _x.feedback.recognised_utterance.end.secs, _x.feedback.recognised_utterance.end.nsecs,) = _get_struct_b4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
