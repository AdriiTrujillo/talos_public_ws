...
"""autogenerated by genpy from pal_interaction_msgs/AudioPlayAction.msg. Do not edit."""
import codecs
import sys
...
class AudioPlayAction(genpy.Message):
  _md5sum = "76100f48e5a10c9758377d0e12c8b6c5"
  _type = "pal_interaction_msgs/AudioPlayAction"
...
"""
  ...
  _slot_types = ['pal_interaction_msgs/AudioPlayActionGoal','pal_interaction_msgs/AudioPlayActionResult','pal_interaction_msgs/AudioPlayActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AudioPlayAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pal_interaction_msgs.msg.AudioPlayActionGoal()
      if self.action_result is None:
        self.action_result = pal_interaction_msgs.msg.AudioPlayActionResult()
      if self.action_feedback is None:
        self.action_feedback = pal_interaction_msgs.msg.AudioPlayActionFeedback()
    else:
      self.action_goal = pal_interaction_msgs.msg.AudioPlayActionGoal()
      self.action_result = pal_interaction_msgs.msg.AudioPlayActionResult()
      self.action_feedback = pal_interaction_msgs.msg.AudioPlayActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_goal.goal.priority, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.file = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.file = str[start:end]
      _x = self
      start = end
      end += 13
      (_x.action_goal.goal.priority, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
