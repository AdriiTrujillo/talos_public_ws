...
"""autogenerated by genpy from pal_interaction_msgs/AudioPlayActionResult.msg. Do not edit."""
import codecs
import sys
...
class AudioPlayActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pal_interaction_msgs/AudioPlayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_interaction_msgs/AudioPlayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AudioPlayActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_interaction_msgs.msg.AudioPlayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_interaction_msgs.msg.AudioPlayResult()
