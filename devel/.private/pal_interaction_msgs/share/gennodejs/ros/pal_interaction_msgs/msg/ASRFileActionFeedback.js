...
class ASRFileActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ASRFileFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ASRFileActionFeedback
    ...
    bufferOffset = ASRFileFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ASRFileActionFeedback
    let len;
    let data = new ASRFileActionFeedback(null);
    ...
    data.feedback = ASRFileFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ASRFileFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ASRFileActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ASRFileFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ASRFileFeedback()
    }
...
module.exports = ASRFileActionFeedback;
