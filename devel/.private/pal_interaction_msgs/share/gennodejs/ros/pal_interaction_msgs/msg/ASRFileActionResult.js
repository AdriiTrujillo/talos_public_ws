...
class ASRFileActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ASRFileResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ASRFileResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ASRFileActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ASRFileResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ASRFileResult()
    }
...
module.exports = ASRFileActionResult;
