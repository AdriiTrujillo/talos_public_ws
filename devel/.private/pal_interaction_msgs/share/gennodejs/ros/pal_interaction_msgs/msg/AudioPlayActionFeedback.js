...
class AudioPlayActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new AudioPlayFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AudioPlayFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AudioPlayActionFeedback(null);
    ...
    data.feedback = AudioPlayFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AudioPlayActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = AudioPlayFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new AudioPlayFeedback()
    }
...
module.exports = AudioPlayActionFeedback;
