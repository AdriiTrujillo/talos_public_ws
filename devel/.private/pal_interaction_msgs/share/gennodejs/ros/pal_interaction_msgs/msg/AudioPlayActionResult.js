...
class AudioPlayActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new AudioPlayResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AudioPlayResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AudioPlayActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = AudioPlayResult.Resolve(msg.result)
    }
    else {
      resolved.result = new AudioPlayResult()
    }
...
module.exports = AudioPlayActionResult;
