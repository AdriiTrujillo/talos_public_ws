...
float64 ak"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3d().pack(_x.angles.angles_in_degrees, _x.angles.ai, _x.angles.aj, _x.angles.ak))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.angles.sequence = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.angles.sequence = str[start:end]
      _x = self
      start = end
      end += 25
      (_x.angles.angles_in_degrees, _x.angles.ai, _x.angles.aj, _x.angles.ak,) = _get_struct_B3d().unpack(str[start:end])
