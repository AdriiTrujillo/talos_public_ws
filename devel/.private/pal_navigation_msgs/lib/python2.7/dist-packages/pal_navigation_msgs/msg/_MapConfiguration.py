...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i3I().pack(_x.numberOfSubMaps, _x.pois.points.header.seq, _x.pois.points.header.stamp.secs, _x.pois.points.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.numberOfSubMaps, _x.pois.points.header.seq, _x.pois.points.header.stamp.secs, _x.pois.points.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
