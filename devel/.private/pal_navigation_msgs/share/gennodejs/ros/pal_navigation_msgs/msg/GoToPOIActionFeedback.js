...
class GoToPOIActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GoToPOIFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GoToPOIFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GoToPOIActionFeedback(null);
    ...
    data.feedback = GoToPOIFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GoToPOIFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoToPOIActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GoToPOIFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GoToPOIFeedback()
    }
...
module.exports = GoToPOIActionFeedback;
