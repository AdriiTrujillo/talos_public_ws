...
class JoyPriorityActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new JoyPriorityFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type JoyPriorityActionFeedback
    ...
    bufferOffset = JoyPriorityFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type JoyPriorityActionFeedback
    let len;
    let data = new JoyPriorityActionFeedback(null);
    ...
    data.feedback = JoyPriorityFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JoyPriorityActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = JoyPriorityFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new JoyPriorityFeedback()
    }
...
module.exports = JoyPriorityActionFeedback;
