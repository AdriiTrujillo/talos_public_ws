...
class JoyPriorityActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JoyPriorityGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JoyPriorityActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = JoyPriorityGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new JoyPriorityGoal()
    }
...
module.exports = JoyPriorityActionGoal;
