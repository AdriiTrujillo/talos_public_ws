...
class JoyTurboActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new JoyTurboFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type JoyTurboActionFeedback
    ...
    bufferOffset = JoyTurboFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type JoyTurboActionFeedback
    let len;
    let data = new JoyTurboActionFeedback(null);
    ...
    data.feedback = JoyTurboFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JoyTurboActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = JoyTurboFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new JoyTurboFeedback()
    }
...
module.exports = JoyTurboActionFeedback;
