...
class JoyTurboActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JoyTurboGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JoyTurboActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = JoyTurboGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new JoyTurboGoal()
    }
...
module.exports = JoyTurboActionGoal;
