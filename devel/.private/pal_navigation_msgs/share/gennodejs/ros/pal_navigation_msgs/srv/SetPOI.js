...
class SetPOIRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetPOIRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetPOIRequest
    let len;
    let data = new SetPOIRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPOIRequest(null);
...
class SetPOIResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetPOIResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetPOIResponse
    let len;
    let data = new SetPOIResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPOIResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: SetPOIRequest,
  Response: SetPOIResponse,
  md5sum() { return 'f0a8811f1068c7b1269d9e58c608681f'; },
  datatype() { return 'pal_navigation_msgs/SetPOI'; }
};
