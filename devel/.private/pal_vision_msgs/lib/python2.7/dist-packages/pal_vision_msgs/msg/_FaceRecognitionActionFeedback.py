...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.feedback.confidence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.order_id,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.names = []
      ...
      self.feedback.confidence = s.unpack(str[start:end])
      return self
