...
class FaceRecognitionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new FaceRecognitionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FaceRecognitionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FaceRecognitionActionFeedback(null);
    ...
    data.feedback = FaceRecognitionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FaceRecognitionFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FaceRecognitionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FaceRecognitionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FaceRecognitionFeedback()
    }
...
module.exports = FaceRecognitionActionFeedback;
