...
class VisualLocRecognizeActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new VisualLocRecognizeFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type VisualLocRecognizeActionFeedback
    ...
    bufferOffset = VisualLocRecognizeFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type VisualLocRecognizeActionFeedback
    let len;
    let data = new VisualLocRecognizeActionFeedback(null);
    ...
    data.feedback = VisualLocRecognizeFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VisualLocRecognizeActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = VisualLocRecognizeFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new VisualLocRecognizeFeedback()
    }
...
module.exports = VisualLocRecognizeActionFeedback;
