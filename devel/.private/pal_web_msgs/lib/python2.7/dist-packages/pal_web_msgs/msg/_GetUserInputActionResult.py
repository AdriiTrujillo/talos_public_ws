...
"""autogenerated by genpy from pal_web_msgs/GetUserInputActionResult.msg. Do not edit."""
import codecs
import sys
...
class GetUserInputActionResult(genpy.Message):
  _md5sum = "78376f1f679a753c718c77d719fce91a"
  _type = "pal_web_msgs/GetUserInputActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_web_msgs/GetUserInputResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetUserInputActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_web_msgs.msg.GetUserInputResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_web_msgs.msg.GetUserInputResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.input.action
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.input.args)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.input.args:
        _x = val1.key
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.input.action = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.input.action = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.result.input.args.append(val1)
      return self
