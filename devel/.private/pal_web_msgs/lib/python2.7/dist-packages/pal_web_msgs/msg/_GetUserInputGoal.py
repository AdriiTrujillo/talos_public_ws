...
class GetUserInputGoal(genpy.Message):
  _md5sum = "6806f4fbea9b42da268e47bd33e0e69b"
...
string lang_id"""
  __slots__ = ['web_go_to','question_tts','valid_asr_inputs','asr_language','asr_timeout','retry_asr','retry_tts']
  _slot_types = ['pal_web_msgs/WebGoTo','pal_interaction_msgs/TtsGoal','string[]','string','duration','bool','pal_interaction_msgs/TtsGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       web_go_to,question_tts,valid_asr_inputs,asr_language,asr_timeout,retry_asr,retry_tts
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.retry_tts.wait_before_speaking
      buff.write(_get_struct_d().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.retry_tts.wait_before_speaking,) = _get_struct_d().unpack(str[start:end])
