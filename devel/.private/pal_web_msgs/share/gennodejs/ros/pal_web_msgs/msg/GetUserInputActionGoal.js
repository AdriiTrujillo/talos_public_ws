...
class GetUserInputActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new GetUserInputGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetUserInputGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GetUserInputGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetUserInputActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GetUserInputGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GetUserInputGoal()
    }
...
module.exports = GetUserInputActionGoal;
