...
let TfStreamGoal = require('./TfStreamGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class TfStreamActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TfStreamGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TfStreamGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TfStreamActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TfStreamGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TfStreamGoal()
    }
...
module.exports = TfStreamActionGoal;
