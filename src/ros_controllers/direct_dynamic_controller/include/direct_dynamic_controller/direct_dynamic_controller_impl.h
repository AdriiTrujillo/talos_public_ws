...
#ifndef DIRECT_DYNAMIC_CONTROLLER_DIRECT_DYNAMIC_CONTROLLER_IMP_H
#define DIRECT_DYNAMIC_CONTROLLER_DIRECT_DYNAMIC_CONTROLLER_IMP_H
...
inline void DirectDynamicController<SegmentImpl, HardwareInterface>::
...
template <class SegmentImpl, class HardwareInterface>
DirectDynamicController<SegmentImpl, HardwareInterface>::
    ...
    hold_trajectory_ptr_(new Trajectory)
{
  ...
  {
    ROS_WARN_STREAM(
        "The direct_dynamic_controller verbose flag is enabled. "
...
template <class SegmentImpl, class HardwareInterface>
bool DirectDynamicController<SegmentImpl, HardwareInterface>::init(HardwareInterface* hw,
                                                                     ...
                                                                     ros::NodeHandle&   controller_nh)
{
  ...
  trajectory_command_sub_ = controller_nh_.subscribe("command", 1, &DirectDynamicController::trajectoryCommandCB, this);
  ...
  action_server_.reset(new ActionServer(controller_nh_, "follow_joint_trajectory",
                                        boost::bind(&DirectDynamicController::goalCB,   this, _1),
                                        boost::bind(&DirectDynamicController::cancelCB, this, _1),
                                        false));
  action_server_->start();

  // ROS API: Provided services
  query_state_service_ = controller_nh_.advertiseService("query_state",
                                                         &DirectDynamicController::queryStateService,
                                                         this);
...
template <class SegmentImpl, class HardwareInterface>
void DirectDynamicController<SegmentImpl, HardwareInterface>::
...
template <class SegmentImpl, class HardwareInterface>
bool DirectDynamicController<SegmentImpl, HardwareInterface>::
