...
//Project
#include <astronaut_controllers/cartesian_controller_torso_efforts.h>
...
bool cartesian_controller_torso_efforts_class::diffTargetFrame(const astronaut_controllers::target_frame& target_frame){
...
void cartesian_controller_torso_efforts_class::targetFrameCallback(const astronaut_controllers::target_frame& target_frame){
